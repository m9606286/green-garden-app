...
class AuthorizationSystem:
    ...
    def display_login_page(self):
        ...
        with st.expander("💡 使用說明"):
            st.markdown("""
            如較長時間未使用，系統會自動休眠，點選藍色長框(Yes, get this app back up!)即可喚醒。
...
class GreenGardenProposal:
    ...
    def _init_cemetery_products(self):
        return {
            "澤茵園": {
                "單灰位": {"定價": 360000, "預購-現金價": 276000, "分期價": 292560, "馬上使用-現金價": 368000, "分期期數": 24, "管理費": 50200},
            ...
            "恩典園一期": {
                ...
                "晨星2灰": {"定價": 200000, "團購-現金價": 105400, "團購-分期價": 111000, "預購-現金價": 120000, "分期價": 128000, "馬上使用-現金價": 160000, "分期期數": 18, "管理費": 21900,"團購-管理費": 16500}
            }
        }
