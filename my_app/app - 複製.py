    ...
    def display_login_page(self):
        ...
        with st.expander("💡 使用說明"):
            ...
            **登入說明頁面：**
            1. 請輸入您的身份證字號
            2. 系統會自動驗證您的授權狀態
            3. 驗證成功後系統會自動帶出業務姓名與所屬營業處
            
            **規劃配置建議書頁面**
            - 於左側輸入基本資訊：客戶姓名、聯絡電話、日期(預設為今日)
            - 於**產品選擇**中，選取欲為客戶規劃的產品後，點選**方案詳情**，系統將自動產生建議書。
            - 點選左上角 **<<** 收合後，再於右上角點選 **⋮** → 選擇 Print 列印建議書。如內容較多超出一頁，請將紙張大小設定為 Legal 或 Tabloid。
            """)
